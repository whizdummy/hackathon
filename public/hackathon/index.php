  ...
  <body style="background-color:#1a1a1a;">
    <div class="wrapper">
        ...
        <div class="parallax-container">
              <div class="parallax  grey darken-4"><img src="./img/bg1.png" class="responsive-img" style="opacity: 0.2;"></div>
                <div class="container">
                    <div class="container">
                      <div class="row">
                          <form class="col s12" method="POST" name="report" onsubmit="return validate()">
                            <div class="col s12">
                              ...
                              <div class="input-field col s12">
                                  <input type="text" class="validate white-text" name="name" id="Name" maxlength="25" required pattern="[a-zA-Z0-9]+" />
                      ...
                      <div class="container">
                        <div class="row">
                              <div class="col s4" style="margin-top: 20px;">
                                  <img src="./img/logo.png" class="responsive-img" width="300">
